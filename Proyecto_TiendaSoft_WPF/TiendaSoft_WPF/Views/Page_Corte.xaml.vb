...
Class Page_Corte
    ...
    Private Sub Crear_labels(x As Integer)
        ...
        Select Case x
            Case 1
                ...
                btn_cerrarTurno.Visibility = Visibility.Visible
            ...
            Case 2
                ...
                sp_datos.Children.Add(lb_fecha)
                btn_cerrarTurno.Visibility = Visibility.Hidden
        End Select
    ...
    Private Sub executar_corteCaja(tipo As Int16)
        If (Mi_conexion.Conectar()) Then
            ...
            Cmd_Procedure.CommandText = "[Global].[Sys_CorteCaja]"
            Cmd_Procedure.Parameters.Clear()
            Cmd_Procedure.Parameters.Add(New SqlClient.SqlParameter("@xtipo", tipo))
            Cmd_Procedure.Parameters.Add(New SqlClient.SqlParameter("@xidOperador", xOpererador))
            ...
            ''Dinero en Caja /Turnos
            Select Case (tipo)
                Case 1
                    cabecera1.Content = "Dinero en Caja"
                    gridDineroCaja.Visibility = Visibility.Visible
                    ...
                    Dim c_xTotal As Decimal = (c_xInicial + c_xEntradas + ventasTotales - c_xSalidas)
                    ...
                    c_Ventas.Content = "+ $" & ventasTotales.ToString("N2")
                    c_Total.Content = "$" & c_xTotal.ToString("N2")

                    sv_turnos.Visibility = Visibility.Collapsed
                    gridDineroCaja.Visibility = Visibility.Visible

                Case 2
                    cabecera1.Content = "Turnos del Dia"
                    gridDineroCaja.Visibility = Visibility.Collapsed
                    sv_turnos.Visibility = Visibility.Visible
            ...
            For Each xrow As DataRow In dataSet.Tables(4).Rows
                Select Case (tipo)
                    Case 1
                        ...
                        lbl_Enombre.Visibility = Visibility.Collapsed
                        lbl_Ehora.Visibility = Visibility.Collapsed
                    ...
                    Case 2
                        ...
                        lbl_Enombre.Visibility = Visibility.Visible
                        lbl_Ehora.Visibility = Visibility.Visible
            ...
            For Each xrow As DataRow In dataSet.Tables(5).Rows
                Select Case (tipo)
                    Case 1
                        ...
                        lbl_Snombre.Visibility = Visibility.Collapsed
                        lbl_Shora.Visibility = Visibility.Collapsed
                    ...
                    Case 2
                        ...
                        lbl_Snombre.Visibility = Visibility.Visible
                        lbl_Shora.Visibility = Visibility.Visible
            ...
            For Each xrow As DataRow In dataSet.Tables(7).Rows
                Select Case (tipo)
                    Case 1
                        ...
                        lbl_ventaNombre.Visibility = Visibility.Collapsed
                    ...
                    Case 2
                        ...
                        lbl_ventaNombre.Visibility = Visibility.Visible
    ...
    Private Sub Agr_DetalleVentas(xtipo As Integer, nombre As String, fecha As String, total As String, pago As String, cambio As String, tipoCobro As String, idventa As Int16, stackpanel As StackPanel)
        ...
        If (xtipo = 2) Then
            ...
            lbl_nombre.HorizontalContentAlignment = HorizontalAlignment.Left
            mySp.Children.Add(lbl_nombre)
        End If
        ...
        lbl_fecha.HorizontalContentAlignment = HorizontalAlignment.Left
        mySp.Children.Add(lbl_fecha)
        ...
        lbl_total.HorizontalContentAlignment = HorizontalAlignment.Left
        ...
        lbl_pago.HorizontalContentAlignment = HorizontalAlignment.Left
        ...
        lbl_cambio.HorizontalContentAlignment = HorizontalAlignment.Left
        ...
        lbl_tCobro.HorizontalContentAlignment = HorizontalAlignment.Left
        mySp.Children.Add(lbl_tCobro)

        Dim lbl_idventa As New TextBox
        lbl_idventa.Text = idventa
        lbl_idventa.Visibility = Visibility.Collapsed
    ...
    Private Sub Agr_DetalleTurnos(nombre As String, fecha As String, m_inicial As String, m_final As String, stackpanel As StackPanel)
        ...
        lbl_minicial.HorizontalContentAlignment = HorizontalAlignment.Left
        ...
        lbl_mfinal.HorizontalContentAlignment = HorizontalAlignment.Left
