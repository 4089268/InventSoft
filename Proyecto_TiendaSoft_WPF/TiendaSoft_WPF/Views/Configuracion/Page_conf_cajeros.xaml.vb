...
Class Page_conf_cajeros
    ...
    Private Sub cargarDatos()
        ...
        Catch
            Dim xm As New msg_error("Error al conectarse con la base de datos")
        End Try
    End Sub
    ...
    Private Sub GuardarModificacionUsuario()
        ...
        If (tb_nombre.Text <> "" And tb_usuario.Text <> "" And tb_password.Password <> "") Then
            ...
            Try
                ...
                reader.Read()
                Dim x As New msg_information(reader("mensaje"))
        ...
        Else
            Dim xm As New msg_information("Verifique que los campos no esten vacios")
        End If
